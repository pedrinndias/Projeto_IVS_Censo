# `docs/relatorios/` — o que o projeto produziu

Resultados e auditorias. Todo número aqui sai de um arquivo gerado por código
versionado; quando não sair, é achado e está marcado como tal.
